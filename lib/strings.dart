...
const new_list_exists = "Список с таким именем уже существует";
const new_item_exists = "Пункт с таким названием уже существует";
...
const confirm_removing_item =
    'Данный элемент удалится безвозвратно. Подтвердите свое согласие';
const removing_item = 'Удаляем элемент ';
